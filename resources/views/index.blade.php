                    ...
                    <div class="contact_form">
                        ...
                        <form action="{{route('register')}}" method="post">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<input class="form-control" id="phone" name="phone" type="tel" placeholder="phone no" required="required" data-validation-required-message="Please enter Phone no.">
										<p class="help-block text-danger"></p>
									</div>
								</div>
								<div class="col-md-6">
								...
								<div class="col-lg-12 text-center">
									<div id="success"></div>
									<button id="sendMessageButton" class="sim-btn hvr-radial-in" data-text="Send Message" type="submit">REGISTER</button>
								</div>
							</div>
						</form>
                    </div>
